...
```{r, echo = FALSE}
group_stage_simulated <- sim_group_stage(schedule_prob, 500)
...
## Most probable pairings in the round of 16
...
## Most Probable Pairing in Quarter Finals
...
## Most Probable Pairing in Semi-Finals
